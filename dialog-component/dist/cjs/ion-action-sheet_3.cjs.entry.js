...
const index$1 = require('./index-1e422699.js');
...
const ActionSheet = class {
  ...
  async present() {
    ...
    this.currentTransition = overlays.present(this, 'actionSheetEnter', iosEnterAnimation$1, mdEnterAnimation$1);
    await this.currentTransition;
  ...
  async dismiss(data, role) {
    this.currentTransition = overlays.dismiss(this, data, role, 'actionSheetLeave', iosLeaveAnimation$1, mdLeaveAnimation$1);
