import { r as registerInstance, k as createEvent, l as Build, h, j as getElement } from './index-998b260f.js';
...
import { m as assert, s as shallowEqualStringMap } from './helpers-2eaa1b44.js';
import { l as lifecycle, L as LIFECYCLE_WILL_UNLOAD, a as LIFECYCLE_WILL_LEAVE, b as LIFECYCLE_DID_LEAVE, t as transition, s as setPageHidden } from './index-7f50a8db.js';
import { a as attachComponent } from './framework-delegate-2bcb0129.js';
...
const Nav = class {
  ...
  async componentDidLoad() {
    this.rootChanged();
    this.gesture = (await import('./swipe-back-d9cb520f.js')).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
