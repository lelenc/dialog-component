import { r as registerInstance, k as createEvent, h, j as getElement } from './index-998b260f.js';
import { g as getIntlMessage } from './translation-219ef791.js';
...
const StepComponent = class {
  ...
  componentDidLoad() {
    ...
    if (dateInput) {
      ...
      //import(`flatpickr/dist/l10n/${this.locale}`).then((localeModule) => {
      //  const localeObject = localeModule.default;
  ...
  render() {
    ...
    return (h("div", { class: "step" }, this.fragment.type != 'Goal' && (h("div", null, h("step-question", { fragment: this.fragment, isActiveQuestion: !(this.answerValue !== null && this.answerValue !== undefined) }), h("div", { class: `answer fade-in right ${this.showContent ? 'show' : ''}` }, this.fragment.type === 'QuestionMenu' && (h("div", { class: "speech-bubble-triangle" }, h("span", { class: "speech-bubble-answer" }, h("div", { class: "options-container" }, this.options.map((op, index) => (h("button", { class: { "answer-button": true, "active": this.answerValue === index }, disabled: this.controlDisabled, onClick: () => this.menuAnswer(index) }, h("div", null, op)))))), h("div", { class: "triangle-topright" }))), this.fragment.type === 'QuestionYesNo' && (h("div", { class: "speech-bubble-triangle" }, h("span", { class: "speech-bubble-answer" }, h("button", { class: { "answer-button": true, "active": this.yesButtonClass() }, disabled: this.controlDisabled, onClick: () => this.yesNoAnswer('true') }, this.messages['question-yes']), h("button", { class: { "answer-button": true, "active": this.noButtonClass() }, disabled: this.controlDisabled, onClick: () => this.yesNoAnswer('false') }, this.messages['question-no'])), h("div", { class: "triangle-topright" }))), this.fragment.type === 'QuestionInteger' && (h("div", { class: "speech-bubble-triangle" }, h("span", { class: "speech-bubble-answer" }, h("form", { onSubmit: (event) => {
        ...
        this.numberAnswer();
      } }, h("input", { type: "number", inputMode: 'numeric', min: "0", step: "1", class: { "answer-input": true, "answered": this.isActive }, value: this.localNumberAnswerValue, onInput: (event) => this.onNumberInput(event), disabled: this.controlDisabled, onKeyDown: () => this.setNumberActive(), style: { width: '8em' } }), h("input", { type: "submit", hidden: true }))), h("div", { class: "triangle-topright" }))), this.fragment.type === 'QuestionDecimal' && (h("div", { class: "speech-bubble-triangle" }, h("span", { class: "speech-bubble-answer" }, h("input", { type: "number", inputMode: 'numeric', class: { "answer-input": true, "answered": this.isActive }, value: this.localNumberAnswerValue, onInput: (event) => this.onNumberInput(event), disabled: this.controlDisabled, onKeyDown: (event) => this.checkNumberInput(event), style: { width: '8em' } })), h("div", { class: "triangle-topright" }))), this.fragment.type === 'QuestionString' && (h("div", { class: "speech-bubble-triangle" }, h("span", { class: "speech-bubble-answer" }, h("input", { type: "text", class: { "answer-input": true, "answered": this.answerValue === this.stringAnswerValue }, value: this.stringAnswerValue, onInput: (event) => (this.stringAnswerValue = event.target.value), disabled: this.controlDisabled, style: { width: '15.5em' } })), h("div", { class: "triangle-topright" }))), this.fragment.type === 'QuestionDate' && (h("div", { class: "speech-bubble-triangle" }, h("span", { class: "speech-bubble-answer date" }, h("form", { id: "dateform", onSubmit: (event) => {
        event.preventDefault();
        console.log("submit");
        this.dateAnswerValue = this.localDateAnswerValue;
        this.setDateActive();
        this.dateAnswer();
      }, style: { marginRight: '0.625em' } }, h("input", { type: "text", id: "dateInput", pattern: "\\d{4}-\\d{2}-\\d{2}", required: true, placeholder: "YYYY-MM-DD", value: this.localDateAnswerValue, class: { "answer-input": true, "answered": this.isDateActive }, disabled: this.controlDisabled, onInput: (event) => this.onDateInput(event), onKeyDown: () => this.setDateActive(), style: { width: '8em' } }), h("input", { type: "submit", hidden: true })), h("button", { id: "date", onClick: () => this.handleButtonClick() }, h("svg", { viewBox: svgViewBox, width: svgWidth }, h("path", { d: svgPathCalendar, fill: svgColor })))), h("div", { class: "triangle-topright" }))))))));
  }
...
export { StepComponent as step_component };

//# sourceMappingURL=step-component.entry.js.map