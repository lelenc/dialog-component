import { r as registerInstance, h, d as createEvent, e as readTask, f as forceUpdate, H as Host, i as getElement } from './index-55cc1141.js';
import { p as popoverController } from './overlays-3788e5bb.js';
import { g as getIonMode, a as isPlatform } from './ionic-global-ba51740c.js';
...
import './framework-delegate-dd6c2f63.js';
...
const getIntlMessage = async (locale) => {
  let messages = {};
  if (locale === 'en') {
    const response = await import('./en.translation-875ca411.js');
    messages = response.default;
  }
  else if (locale === 'hu') {
    const response = await import('./hu.translation-3462994f.js');
    messages = response.default;
  }
  return messages;
};
...
export { DescriptionComponent as description_component, DialogComponent as dialog_component, Content as ion_content, ResultComponent as result_component, StepComponent as step_component, StepQuestion as step_question };

//# sourceMappingURL=description-component_6.entry.js.map