...
const gestureController = require('./gesture-controller-56ea023a.js');
...
const index$2 = require('./index-eafee97e.js');
const focusVisible = require('./focus-visible-b9a2f5db.js');
const data = require('./data-02090e52.js');
...
const index$3 = require('./index-fa3bca69.js');
const animation = require('./animation-e7c8a005.js');
require('./hardware-back-button-92d97ff8.js');
require('./index-32ab254f.js');
...
const getHighlightStyles = (highlightedDates, dateIsoString, el) => {
  if (Array.isArray(highlightedDates)) {
    ...
    try {
      ...
      index$1.printIonError('Exception thrown from provided `highlightedDates` callback. Please check your function and try again.', el, e);
    }
  }
  return undefined;
};
  ...
  constructor(hostRef) {
    ...
    this.warnIfIncorrectValueUsage = () => {
      ...
      if (!multiple && Array.isArray(value)) {
         ...
         * Custom behavior: ['a', 'b']
         */
        index$1.printIonWarning(`ion-datetime was passed an array of values, but multiple="false". This is incorrect usage and may result in unexpected behaviors. To dismiss this warning, pass a string to the "value" property when multiple="false".
...
`, this.el);
  ...
  componentWillLoad() {
    ...
    if (highlightedDates !== undefined) {
      if (presentation !== 'date' && presentation !== 'date-time' && presentation !== 'time-date') {
        index$1.printIonWarning('The highlightedDates property is only supported with the date, date-time, and time-date presentations.', el);
      }
      if (preferWheel) {
        index$1.printIonWarning('The highlightedDates property is not supported with preferWheel="true".', el);
      }
    }
    this.processMinParts();
    this.processMaxParts();
  ...
  renderCalendarHeader(mode) {
    ...
    return (index.h("div", { class: "calendar-header" }, index.h("div", { class: "calendar-action-buttons" }, index.h("div", { class: "calendar-month-year" }, index.h("ion-item", { ref: (el) => (this.monthYearToggleItemRef = el), button: true, "aria-label": "Show year picker", detail: false, lines: "none", onClick: () => {
        var _a;
        this.toggleMonthAndYearView();
        /**
         * TODO: FW-3547
    ...
    return (index.h("div", { "aria-hidden": !isWorkingMonth ? 'true' : null, class: {
      ...
      if (!isCalDayDisabled && isDateEnabled !== undefined) {
        try {
          ...
          index$1.printIonError('Exception thrown from provided `isDateEnabled` function. Please check your function and try again.', el, e);
        }
      }
      ...
      return (index.h("button", { tabindex: "-1", "data-day": day, "data-month": month, "data-year": year, "data-index": index$2, "data-day-of-week": dayOfWeek, disabled: isCalDayDisabled, class: {
        ...
        } }, index.h("div", { class: "calendar-day-highlight", style: {
...
const Item = class {
  constructor(hostRef) {
    ...
    this.detailIcon = index$2.chevronForward;
    this.disabled = false;
    this.download = undefined;
    this.fill = undefined;
    this.shape = undefined;
  ...
  componentDidLoad() {
    ...
    if (hasHelperSlot) {
      index$1.printIonWarning('The "helper" slot has been deprecated in favor of using the "helperText" property on ion-input or ion-textarea.', el);
    }
    const hasErrorSlot = el.querySelector('[slot="error"]') !== null;
    if (hasErrorSlot) {
      index$1.printIonWarning('The "error" slot has been deprecated in favor of using the "errorText" property on ion-input or ion-textarea.', el);
    }
    if (counter === true) {
      index$1.printIonWarning('The "counter" property has been deprecated in favor of using the "counter" property on ion-input or ion-textarea.', el);
    }
    if (counterFormatter !== undefined) {
      index$1.printIonWarning('The "counterFormatter" property has been deprecated in favor of using the "counterFormatter" property on ion-input or ion-textarea.', el);
    }
    if (fill !== undefined) {
      index$1.printIonWarning('The "fill" property has been deprecated in favor of using the "fill" property on ion-input or ion-textarea.', el);
    }
    if (shape !== undefined) {
      index$1.printIonWarning('The "shape" property has been deprecated in favor of using the "shape" property on ion-input or ion-textarea.', el);
    }
    helpers.raf(() => {
  ...
  render() {
    ...
    return (index.h(index.Host, { "aria-disabled": ariaDisabled, class: Object.assign(Object.assign(Object.assign({}, childStyles), labelColorStyles), theme.createColorClasses(this.color, {
      ...
      })), role: inList ? 'listitem' : null }, index.h(TagType, Object.assign({}, attrs, inheritedAriaAttributes, { class: "item-native", part: "native", disabled: disabled }, clickFn), index.h("slot", { name: "start" }), index.h("div", { class: "item-inner" }, index.h("div", { class: "input-wrapper" }, index.h("slot", null)), index.h("slot", { name: "end" }), showDetail && (index.h("ion-icon", { icon: detailIcon, lazy: false, class: "item-detail-icon", part: "detail-icon", "aria-hidden": "true", "flip-rtl": detailIcon === index$2.chevronForward })), index.h("div", { class: "item-inner-highlight" })), canActivate && mode === 'md' && index.h("ion-ripple-effect", null), index.h("div", { class: "item-highlight" })), index.h("div", { class: "item-bottom" }, index.h("slot", { name: "error" }), index.h("slot", { name: "helper" }), counterString && index.h("ion-note", { class: "item-counter" }, counterString))));
  }
...
const getIntlMessage = async (locale) => {
  let messages = {};
  if (locale === 'en') {
    const response = await Promise.resolve().then(function () { return require('./en.translation-296c5497.js'); });
    messages = response.default;
  }
  else if (locale === 'hu') {
    const response = await Promise.resolve().then(function () { return require('./hu.translation-27041673.js'); });
    messages = response.default;
  }
  return messages;
};
...
const StepComponent = class {
  ...
  render() {
    ...
    return (index.h("div", { class: "step" }, this.fragment.type != 'Goal' && (index.h("div", null, index.h("step-question", { fragment: this.fragment, isActiveQuestion: !(this.answerValue !== null && this.answerValue !== undefined) }), index.h("div", { class: `answer fade-in right ${this.showContent ? 'show' : ''}` }, this.fragment.type === 'QuestionMenu' && (index.h("div", { class: "speech-bubble-triangle" }, index.h("span", { class: "speech-bubble-answer" }, index.h("div", { class: "options-container" }, this.options.map((op, index$1) => (index.h("button", { class: { "answer-button": true, "active": this.answerValue === index$1 }, disabled: this.controlDisabled, onClick: () => this.menuAnswer(index$1) }, index.h("div", null, op)))))), index.h("div", { class: "triangle-topright" }))), this.fragment.type === 'QuestionYesNo' && (index.h("div", { class: "speech-bubble-triangle" }, index.h("span", { class: "speech-bubble-answer" }, index.h("button", { class: { "answer-button": true, "active": this.yesButtonClass() }, disabled: this.controlDisabled, onClick: () => this.yesNoAnswer('true') }, this.messages['question-yes']), index.h("button", { class: { "answer-button": true, "active": this.noButtonClass() }, disabled: this.controlDisabled, onClick: () => this.yesNoAnswer('false') }, this.messages['question-no'])), index.h("div", { class: "triangle-topright" }))), this.fragment.type === 'QuestionInteger' && (index.h("div", { class: "speech-bubble-triangle" }, index.h("span", { class: "speech-bubble-answer" }, index.h("form", { onSubmit: (event) => {
        ...
        this.numberAnswer();
      } }, index.h("input", { type: "number", inputMode: 'numeric', min: "0", step: "1", class: { "answer-input": true, "active": this.isActive }, value: this.localNumberAnswerValue, onInput: (event) => this.onNumberInput(event), disabled: this.controlDisabled, onKeyDown: () => this.setNumberActive(), style: { width: '8em' } }), index.h("input", { type: "submit", hidden: true }))), index.h("div", { class: "triangle-topright" }))), this.fragment.type === 'QuestionDecimal' && (index.h("div", { class: "speech-bubble-triangle" }, index.h("span", { class: "speech-bubble-answer" }, index.h("input", { type: "number", inputMode: 'numeric', class: { "answer-input": true, "active": this.isActive }, value: this.localNumberAnswerValue, onInput: (event) => this.onNumberInput(event), disabled: this.controlDisabled, onKeyDown: (event) => this.checkNumberInput(event), style: { width: '8em' } })), index.h("div", { class: "triangle-topright" }))), this.fragment.type === 'QuestionString' && (index.h("div", { class: "speech-bubble-triangle" }, index.h("span", { class: "speech-bubble-answer" }, index.h("input", { type: "text", class: { "answer-input": true, "active": this.answerValue === this.stringAnswerValue }, value: this.stringAnswerValue, onInput: (event) => (this.stringAnswerValue = event.target.value), disabled: this.controlDisabled, style: { width: '15.5em' } })), index.h("div", { class: "triangle-topright" }))), this.fragment.type === 'QuestionDate' && (index.h("div", { class: "speech-bubble-triangle" }, index.h("span", { class: "speech-bubble-answer date" }, index.h("form", { onSubmit: (event) => {
        event.preventDefault();
        console.log("submit");
        this.dateAnswerValue = this.localDateAnswerValue;
        this.setDateActive();
        this.dateAnswer();
      }, style: { marginRight: '0.625em' } }, index.h("input", { type: "text", pattern: "\\d{4}-\\d{2}-\\d{2}", required: true, placeholder: "YYYY-MM-DD", value: this.localDateAnswerValue, class: { "answer-input": true, "active": this.isDateActive }, disabled: this.controlDisabled, onInput: (event) => this.onDateInput(event), onKeyDown: () => this.setDateActive(), style: { width: '8em' } }), index.h("input", { type: "submit", hidden: true })), index.h("button", { id: "date", onClick: (ev) => this.presentPopover(ev) }, index.h("svg", { viewBox: svgViewBox, width: svgWidth }, index.h("path", { d: svgPathCalendar, fill: svgColor })))), index.h("div", { class: "triangle-topright" }))))))));
  }
...
const StepQuestion = class {
  ...
  render() {
    ...
    return (index.h("div", { class: `question fade-in left ${this.showContent ? 'show' : ''}` }, index.h("div", { class: "speech-bubble-triangle" }, index.h("div", { class: "triangle-topleft" }), index.h("span", { class: { "speech-bubble-question": true, "active": this.isActiveQuestion }, innerHTML: this.fragment.labelLayman })), index.h("svg", { id: `button-${this.fragment.iri}`, class: "infoicon clickable", width: svgWidth, viewBox: svgViewBox, onClick: (ev) => this.presentPopover(ev) }, index.h("path", { d: svgPath, fill: svgColor }))));
  }
  static get watchers() { return {
    "fragment": ["handleFragmentValueChange"]
  }; }
...
//# sourceMappingURL=description-component_18.cjs.entry.js.map