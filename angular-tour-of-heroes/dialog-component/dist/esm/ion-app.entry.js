...
import { g as getIonMode, c as config, a as isPlatform } from './ionic-global-ba51740c.js';
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (!config.getBoolean('_testing')) {
          import('./index-1dd8c01a.js').then((module) => module.startTapClick(config));
        }
        if (config.getBoolean('statusTap', isHybrid)) {
          import('./status-tap-dcd72692.js').then((module) => module.startStatusTap());
        }
        if (config.getBoolean('inputShims', needInputShims())) {
          ...
          import('./input-shims-9a5f5a43.js').then((module) => module.startInputShims(config, platform));
        }
        ...
        if (typeof window !== 'undefined') {
          import('./keyboard-3c28772c.js').then((module) => module.startKeyboardAssist(window));
        }
